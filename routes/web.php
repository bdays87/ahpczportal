...
use App\Livewire\Admin\Historicaldataapprovals;
...
use App\Livewire\Customer\ProfileUpdate;
use App\Livewire\Customer\Resources as CustomerResources;
...
Volt::route('/reset-password', Reset::class)->name('password.reset');
...
Route::group([
    ...
    Volt::route('/resources', AdminResources::class)->name('admin.resources.index');
    ...
    Route::get('/journals/{slug}/view', \App\Livewire\Customer\Viewjournal::class)->name('customer.journals.view')->where('slug', '[a-z0-9-]+');
    ...
    Route::get('/customer-contacts', \App\Livewire\Admin\Customercontactreport::class)->name('customercontactreport.index');
