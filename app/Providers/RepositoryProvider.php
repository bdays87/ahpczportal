...
use App\implementations\_customerhistoricaldataRepository;
...
use App\implementations\_resourceRepository;
...
class RepositoryProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->bind(iresourceInterface::class, _resourceRepository::class);
        ...
        $this->app->bind(icustomerhistoricaldataInterface::class, _customerhistoricaldataRepository::class);
