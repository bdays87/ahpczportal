...
<td class="td-top">
    ...
    <div class="cert-type">STATE CERTIFIED BLOOD TRANSFUSION TECHNICIAN CERTIFICATE</div>
    ...
    <div class="body-text">
        <br> <br> <br>  <br> <br> <br>
         has passed the final examination for State Certified Blood Transfusion Technicians conducted by the Medical Laboratory and Clinical Scientists Council of Zimbabwe and has successfully completed a two year prescribed course of training
    </div>
</td>
</tr>
<tr>
<td class="td-bot">
    ...
    <td class="sig-cell">
        ...
        <div class="sig-block">
            <br> <br> <br>
            <img class="sig-img" src="./imgs/chairman_signature.png" alt="Chairman Signature">
 ...
 <br> <br> <br>
    ...
    <tr>
    <td class="date-cell">
        <div class="date-line">{{ \Carbon\Carbon::parse($data->registration_date)->format('d F Y') }}</div>
        <div class="date-label">Date</div>
         <div class="scmlt-cell" style="text-align: left">SCBTT:</div>
    </td>
