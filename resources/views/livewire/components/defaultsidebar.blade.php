    ...
    <x-slot:sidebar drawer="main-drawer" collapsible class="bg-base-200 text-gray-500 border border-r-gray-200">
        ...
        <x-menu activate-by-route active-class="bg-green-300 font-semibold shadow-lg border-l-4 " class="px-2 py-4">
            ...
            <x-menu-item 
                ...
                class=" rounded-lg transition-all duration-200 mb-2  hover:text-yellow-300 hover:translate-x-1"
            />
            ...
            <x-menu-item 
                ...
                class="hover:bg-white/10 rounded-lg transition-all duration-200 mb-2  hover:text-yellow-300 hover:translate-x-1"
            />
